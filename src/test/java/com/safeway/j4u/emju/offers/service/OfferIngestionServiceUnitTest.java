...
public class OfferIngestionServiceUnitTest {
  ...
  public void updateStatus() {
    ...
    verify(reactiveCassandraTemplate, times(3)).getReactiveCqlOperations();
    verify(reactiveCqlOperations, times(3)).execute(any(Statement.class));
  ...
  private Flux<OfferDetails> stubTwoOfferDetails() {
    return Flux.just(OfferDetails.builder()
        .externalOfferId("1").offerId(1L).offerStatus("A").build(), OfferDetails.builder()
        .externalOfferId("2").offerId(2L).offerStatus("A").build());
